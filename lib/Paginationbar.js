...
var propTypes = {
  ...
  visibility: _propTypes.default.number,
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement(_reactstrap.Pagination, {
      ...
      previous: true
    })), this.renderPages(currentPage, firstPage, lastPage), _react.default.createElement(_reactstrap.PaginationItem, {
      onClick: function onClick() {
  ...
  _proto.renderPages = function renderPages(currentPage, firstPage, lastPage) {
    ...
    if (ellipsis && hasPreviousEllipsis) pages.push(_react.default.createElement(_reactstrap.PaginationItem, {
      key: "page-previous-ellipsis",
      disabled: true
    }, _react.default.createElement(_reactstrap.PaginationLink, null, "\u2026")));

    var _loop = function _loop(i) {
      pages.push(_react.default.createElement(_reactstrap.PaginationItem, {
        key: "page-" + i,
        onClick: function onClick() {
          return _this3.handleGoTo(i);
        },
        active: i === currentPage
      }, _react.default.createElement(_reactstrap.PaginationLink, null, i)));
    };
    ...
    if (ellipsis && hasNextEllipsis) pages.push(_react.default.createElement(_reactstrap.PaginationItem, {
