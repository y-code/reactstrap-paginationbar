  ...
  render() {
    return (
      <Navbar className="header" color="faded" light expand="md">
        <Container>
          <NavbarBrand className="mr-auto" tag={Link} to="/">reactstrap-paginationbar</NavbarBrand>
          ...
          <Collapse navbar isOpen={this.state.showNavbar}>
            <Nav navbar className="ml-sm-auto">
              ...
              <NavItem>
                <NavLink href="https://github.com/y-code/reactstrap-paginationbar">GitHub</NavLink>
              </NavItem>
            </Nav>
          </Collapse>
        </Container>
